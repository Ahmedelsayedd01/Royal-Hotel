  ...
  return (
    <div className="w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2">
      <div className="max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4">
        ...
        <div className="col-span-2 py-8 md:pt-2">
          ...
          <form className="flex flex-col sm:flex-row">
            <input
              className="w-full text-black text-lg p-2 mr-4 rounded-md mb-4"
              type="email"
      ...
      <div className="flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500">
        <p className="py-4">
          Copyright <span className="text-white">&copy;</span> 2022 Royal Hotel.
          All All rights reserved.
        </p>
        <div className="flex justify-between sm:w-[300px] pt-4 text-2xl">
          <FaFacebook className="cursor-pointer hover:text-[#4267B2] transition-all duration-500" />
          <FaInstagram className="cursor-pointer hover:text-[#F56040] transition-all duration-500" />
          <FaTwitter className="cursor-pointer hover:text-[#1DA1F2] transition-all duration-500" />
          <TiSocialPinterest
            size={30}
            className="cursor-pointer hover:text-[#E60023] transition-all duration-500"
          />
        </div>
      </div>
    </div>
